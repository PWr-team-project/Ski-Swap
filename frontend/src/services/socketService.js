...
class SocketService {
  ...
  // Listen for new booking messages
  onBookingMessageReceived(callback) {
    if (this.socket) {
      this.socket.on('booking-message:received', callback)
      this.listeners.set('booking-message:received', callback)
    }
  }
